...
#define EPSON12_PCIE_AREA_SIZE	(384*1024*1024)
#define IRQ_PCIE		(IRQ_PCIE0)
#define PCIE_PORT_NUM		(0)
...
static u32 dwcpcie_init(u32 on_ltssm, u32 ip_mode)
{
	...
	//dbi_writel( (dbi_readl(0x78) | (1<<5)) , 0x78);	// ZANTEI	Max_Payload_Size:256bytes
...
int epson12_pcie0_recovery(void)
{
...
EXPORT_SYMBOL(epson12_pcie0_recovery);
EXPORT_SYMBOL(epson12_pcie0_stop);
